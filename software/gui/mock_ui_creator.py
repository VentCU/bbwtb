...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def initialize_plots(self):
        ...
        self.pressure_curve = self.pressure_graph.plot(x_axis, pressure_data, pen=pen)
        self.flow_curve = self.flow_graph.plot(x_axis, flow_data, pen=pen)
        self.volume_curve = self.volume_graph.plot(x_axis, volume_data,pen=pen)
